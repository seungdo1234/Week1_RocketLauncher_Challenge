...
public class AchievementManager : MonoBehaviour
{
    ...
    [SerializeField]private int currentAchieveLevel = 0;
    private void Awake()
    { 
        Instance = this;
    }
    ...
    {
        if (currentAchieveLevel < achievements.Length && achievements[currentAchieveLevel].threshold <= height )
        {
            achievements[currentAchieveLevel].isUnlocked = true;
            achievementView.UnlockAchievement(currentAchieveLevel);
            currentAchieveLevel++;
        }
    }
}